...
export const OCCASION_TYPES: OccasionType[] = [
  ...
  { id: 'nikah', label: 'Nikah ceremony', category: 'celebration', defaultFormality: 'formal' },
  { id: 'walima', label: 'Walima reception', category: 'celebration', defaultFormality: 'formal' },
  { id: 'wedding-reception', label: 'Wedding reception', category: 'celebration', defaultFormality: 'formal' },
  { id: 'roka', label: 'Roka / ring ceremony', category: 'celebration', defaultFormality: 'formal' },
  { id: 'eid', label: 'Eid celebration', category: 'celebration', defaultFormality: 'smart-casual' },
  { id: 'iftar', label: 'Iftar dinner', category: 'celebration', defaultFormality: 'smart-casual' },
  { id: 'diwali', label: 'Diwali celebration', category: 'celebration', defaultFormality: 'smart-casual' },
  { id: 'garba-night', label: 'Garba / Dandiya night', category: 'celebration', defaultFormality: 'smart-casual' },
  { id: 'puja', label: 'Puja / prayer gathering', category: 'celebration', defaultFormality: 'smart-casual' },
  { id: 'rakhi', label: 'Raksha Bandhan', category: 'celebration', defaultFormality: 'casual' },
  { id: 'bridal-shower', label: 'Bridal shower', category: 'celebration', defaultFormality: 'smart-casual' },
  { id: 'aqiqah', label: 'Aqiqah / naming ceremony', category: 'celebration', defaultFormality: 'smart-casual' },
